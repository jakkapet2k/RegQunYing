...
public class MemberAdd extends JPanel implements ActionListener {
	...
	private static final String ADD_STR = "เพิ่ม";
	...
	public void actionPerformed(ActionEvent evt) {
		...
		try {
			...
			if (source == GenderCB) {
				...
				Item selectedType = (Item) TeacherCB.getSelectedItem();
				TeacherName = selectedType.toString();
				...
				try {
					...
					Member Add = new Member(mid, fname, sname, age, bddate, gender, phone, edu, job, address, adate,
